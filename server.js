...
const defaultTheme = {
    ...
    colors: {
        bluePrimary: "#00d2ff", blueDark: "#003e4d",
        redPrimary: "#ff2a2a", redDark: "#4d0000",
        scoreBlue: "#00d2ff", scoreRed: "#ff2a2a",
        
        upperBg: "#000000", lowerBg: "#0a0a0a", lowerMidBg: "#111111",
        heroPickBg: "#1e1e1e", logoTeamBg: "#000000",
        postDraftBg: "#1a1a1a",
        playerNameBg: "#000000", laneLogoBg: "rgba(0,0,0,0.8)",

        timerBlue: "#00d2ff", timerMid: "#ffffff", timerRed: "#ff2a2a",
        playerName: "#ffffff", phaseText: "#ffffff", 
        
        laneIconType: "white", laneLogoBorder: "#ffffff",
        auraBan: "#ff0000", auraPick: "#ffffff",
    ...
    scoreboard: {
        teamNameBlue: "#00d2ff", teamNameRed: "#ff2a2a",
        bgTeamName: "#1e1e1e", bgLogo: "#000000", bgScore: "#000000",
        bgCombined: "#0a0a0a", bgBox1: "#1e1e1e", bgSecondary: "#1e1e1e",
        borderBottom: "rgba(255, 255, 255, 0.2)",
        activeFlag: "indonesia.png",
        disableGlow: false, disableShadow: false
    },
    
    opacity: {
        upper: 100, lower: 100, heroPick: 100, logoTeam: 60, postDraft: 100
    },

    toggles: {
        hideLaneLogo: false, disableGlow: false, hidePattern: false, 
        hidePostDraftBg: false, disableBoxShadow: false 
    },
    
    animations: { 
        banType: "pulse", pickType: "pulse", heroAnim: "fade"
    }
};
